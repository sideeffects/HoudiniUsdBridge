...
PXR_NAMESPACE_OPEN_SCOPE
    static size_t
    UTformatBuffer(char *buffer, size_t bufsize, const VtValue &v)
    {
...
SDR_REGISTER_PARSER_PLUGIN(BRAY_SdrKarmaParser)
...
{
    static const SdrTokenVec _DiscoveryTypes = {
...
BRAY_SdrKarmaParser::ParseShaderNode(
...
static SdrShaderPropertyUniquePtrVec
propertiesFromBuiltin(const TfToken &name, const SdrTokenMap &metadata)
{
    static const TfToken theKarmaRep("karma_rep", TfToken::Immortal);
    static const TfToken theKarmaRepOLen("karma_rep_olen", TfToken::Immortal);
    ...
    {
        return SdrShaderPropertyUniquePtrVec();
    }
...
BRAY_SdrKarmaParser::getNodeProperties(const SdrShaderNodeDiscoveryResult& discoveryResult)
{
    bool ok = false;

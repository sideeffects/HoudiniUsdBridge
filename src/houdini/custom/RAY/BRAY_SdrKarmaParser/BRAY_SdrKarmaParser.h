...
#ifndef __BRAY_SDRKARMAPARSER_H__
#define __BRAY_SDRKARMAPARSER_H__
...
class BRAY_SdrKarmaParser : public SdrParserPlugin
{
public:
    BRAY_SdrKarmaParser();
    ~BRAY_SdrKarmaParser() override;
...
private:
    SdrShaderPropertyUniquePtrVec getNodeProperties(

...
bool
HD_DrawModeAdapter::CanPopulateMaster() const
{
    return true;
}
...
HD_DrawModeAdapter::GetTextureResourceID(UsdPrim const& usdPrim,
                                                       SdfPath const &id,
                                                       UsdTimeCode time,
                                                       size_t salt) const
{
...
HD_DrawModeAdapter::GetTextureResource(UsdPrim const& usdPrim,
                                                     SdfPath const &id,

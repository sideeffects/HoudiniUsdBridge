                                  ...
                                  size_t salt)
{
    ...
    BOOST_NS::hash_combine(hash, origin);
    BOOST_NS::hash_combine(hash, wrapS);
    BOOST_NS::hash_combine(hash, wrapT);
    BOOST_NS::hash_combine(hash, minFilter);
    BOOST_NS::hash_combine(hash, magFilter);
    BOOST_NS::hash_combine(hash, memoryLimit);
    ...
    BOOST_NS::hash_combine(hash, salt);
                                ...
                                UsdTimeCode time)
{
    ...
    texResource = HdTextureResourceSharedPtr(
        new HdStSimpleTextureResource(texture, textureType, wrapS, wrapT, wrapR,

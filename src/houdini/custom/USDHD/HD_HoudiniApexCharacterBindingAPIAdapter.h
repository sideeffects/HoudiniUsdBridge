...
/// Hydra API schema adapter for HoudiniApexCharacterBindingAPI.
class HD_HoudiniApexCharacterBindingAPIAdapter
    : public UsdImagingAPISchemaAdapter
{
public:
    using BaseAdapter = UsdImagingAPISchemaAdapter;

    HD_HoudiniApexCharacterBindingAPIAdapter();
    ~HD_HoudiniApexCharacterBindingAPIAdapter() override;

    UT_NON_COPYABLE(HD_HoudiniApexCharacterBindingAPIAdapter)

...
/// Hydra prim adapter for HoudiniApexScene primitives.
class HD_HoudiniApexSceneAdapter : public UsdImagingSceneIndexPrimAdapter
{
public:
    using BaseAdapter = UsdImagingSceneIndexPrimAdapter;

    HD_HoudiniApexSceneAdapter();
    ~HD_HoudiniApexSceneAdapter() override;

    UT_NON_COPYABLE(HD_HoudiniApexSceneAdapter)

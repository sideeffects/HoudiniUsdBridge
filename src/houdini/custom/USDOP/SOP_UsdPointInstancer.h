...
#ifndef __SOP_UsdPointInstancer_h__
#define __SOP_UsdPointInstancer_h__
...
class SOP_UsdPointInstancer : public SOP_Node
{
public:
   ...
   static OP_Node *myConstructor(
           ...
           OP_Operator *op)
   {
       return new SOP_UsdPointInstancer(net, name, op);
   }
...
protected:
   SOP_UsdPointInstancer(OP_Network *net, const char *name, OP_Operator *op);

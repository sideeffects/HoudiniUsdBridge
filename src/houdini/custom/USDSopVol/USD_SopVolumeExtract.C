...
extern "C"
{
    // I doubt SYS_DEPRECATED here does anything since these functions are
    // meant to be used via dlsym, but added anyway for your information
    SYS_DEPRECATED_REPLACE(19.5, SOPgetVDBVolumePrimitiveWithIndex)
    ...
    {
        return HUSD_HydraField::getVolumePrimitive(filepath, name, index,
            HusdHdPrimTypeTokens->houdiniFieldAsset.GetString());
    }
}

...
{
public:
    XUSD_ImagingEngineGL(const Parameters &params);
    ...
    bool SetRendererPlugin(TfToken const &id, const HdRenderSettingsMap &) override;
...
private:
    ...
    bool myFastPathColor;

#ifdef KARMA_OUTPUT_GPU_BUFFERS
    UT_StringMap<PXL_Raster *> _aovRasters;
#endif
};

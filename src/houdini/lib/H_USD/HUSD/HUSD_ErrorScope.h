...
enum HUSD_ErrorCodes
{
    ...
    HUSD_ERR_LAYER_SAVE_FAILED = 36,
    HUSD_ERR_CANT_FIND_PROPERTY = 37,
    HUSD_ERR_CANT_CREATE_PROPERTY = 38,
    HUSD_ERR_STAGE_LOCK_FAILED = 39,
    HUSD_ERR_INVALID_INTERPOLATION = 40,
};

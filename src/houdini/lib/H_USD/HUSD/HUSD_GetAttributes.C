...
HUSD_EXPLICIT_INSTANTIATION_SET(fpreal16)
...
HUSD_EXPLICIT_INSTANTIATION_SET(UT_Vector2H)
HUSD_EXPLICIT_INSTANTIATION_SET(UT_Vector3H)
HUSD_EXPLICIT_INSTANTIATION_SET(UT_Vector4H)
...
HUSD_EXPLICIT_INSTANTIATION_SET(HUSD_AssetPath)

...
public:
    ...
    // Instance only; getBounds gives the bbox around all instances.
    bool        getLocalBounds(UT_BoundingBox &box) const;

    GT_TransformArrayHandle getTransforms() const;

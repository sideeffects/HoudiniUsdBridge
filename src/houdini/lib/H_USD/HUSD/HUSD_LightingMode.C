...
namespace
{
    ...
    constexpr UT_StringLit theDomelightOnlyStr(
        "Dome Light Only");
    constexpr UT_StringLit thePhysicalSkylightOnlyStr(
        "Physical Sky Only");
    constexpr UT_StringLit theThreePointOnlyStr(
        "Three Point Only");
    ...
    UT_Map<UT_StringHolder, HUSD_LightingMode> theStringsToLightingModes({
        ...
        { thePhysicalSkylightOnlyStr.asHolder(), HUSD_LIGHTING_MODE_PHYSICAL_SKY_ONLY },
        { theThreePointOnlyStr.asHolder(), HUSD_LIGHTING_MODE_THREE_POINT_ONLY },

...
enum HUSD_LightingMode {
    ...
    HUSD_LIGHTING_MODE_PHYSICAL_SKY_ONLY = 3,
    HUSD_LIGHTING_MODE_THREE_POINT_ONLY = 4,
    HUSD_LIGHTING_MODE_NORMAL = 5,
    HUSD_LIGHTING_MODE_HQ = 6,
    HUSD_LIGHTING_MODE_HQ_SHADOWS = 7,
    HUSD_LIGHTING_MODE_COUNT = 8
};

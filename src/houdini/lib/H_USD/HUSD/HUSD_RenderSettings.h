...
namespace HUSD_RenderTokens
{
    ...
    HUSD_API const char *instantaneousShutter();
...
public:
    ...
    /// @{
    /// Default & override product name
    virtual const char  *defaultProductName() const { return nullptr; }
    virtual const char  *overrideProductName(const HUSD_RenderProduct &p) const
                            { return nullptr; }
    /// @}
    /// Default path for snapshots (in husk)
    virtual const char  *overrideSnapshotPath(const HUSD_RenderProduct &p) const
                            { return nullptr; }

    /// Override the snapshot suffix (in husk)
    virtual const char  *overrideSnapshotSuffix(const HUSD_RenderProduct &p) const
                            { return "_part"; }
    ...
    virtual fpreal       overridePixelAspect(fpreal pa) const
                            { return pa; }
    virtual bool         overrideInstantaneousShutter(bool is) const
                            { return is; }
    /// @}
...
public:
    ...
    bool                instantaneousShutter(const HUSD_RenderProduct *p) const;
    ...
    bool                instantaneousShutter(int product_group) const
                            { return instantaneousShutter(productInGroup(product_group)); }
    /// @}

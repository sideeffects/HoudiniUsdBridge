...
/// \file usdHoudini/houdiniFieldAsset.h
...
/// \class UsdHoudiniHoudiniFieldAsset
///
...
public:
    ...
    /// an invalid \p prim
    explicit UsdHoudiniHoudiniFieldAsset(const UsdPrim& prim=UsdPrim())
        : UsdVolFieldAsset(prim)
    {
    }

    /// Construct a UsdHoudiniHoudiniFieldAsset on the prim held by \p schemaObj .
    /// Should be preferred over UsdHoudiniHoudiniFieldAsset(schemaObj.GetPrim()),
    /// as it preserves SchemaBase state.
    explicit UsdHoudiniHoudiniFieldAsset(const UsdSchemaBase& schemaObj)
        : UsdVolFieldAsset(schemaObj)
    {
    }

    /// Destructor.
    virtual ~UsdHoudiniHoudiniFieldAsset();

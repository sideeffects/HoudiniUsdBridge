...
static UsdAttribute
_CreateFieldNameAttr(UsdHoudiniHoudiniFieldAsset &self,
...
static UsdAttribute
_CreateFieldIndexAttr(UsdHoudiniHoudiniFieldAsset &self,
                                      object defaultVal, bool writeSparsely) {
...
void wrapUsdHoudiniHoudiniFieldAsset()
{
    typedef UsdHoudiniHoudiniFieldAsset This;

    class_<This, bases<UsdVolFieldAsset> >
        cls("HoudiniFieldAsset");

...
UTformatBuffer(char *buffer, size_t bufsize, const TYPE &val) \
{ \
...
static SYS_FORCE_INLINE size_t
UTformatBuffer(char *buffer, size_t bufsize, const SdfPath &val)
{
    UT::Format::Writer  writer(buffer, bufsize);
    UT::Format::Formatter     f;
...
static SYS_FORCE_INLINE size_t
UTformatBuffer(char *buffer, size_t bufsize, HdFormat val)
{
    UT::Format::Writer		writer(buffer, bufsize);
    UT::Format::Formatter	f;
	...
	case HdFormatUInt16:	tname = "uint16"; break;
	case HdFormatInt16:	tname = "int16"; break;
...
static SYS_FORCE_INLINE size_t
UTformatBuffer(char *buffer, size_t bufsize, const TfTokenVector &vtok)
{
...
template <typename T>
static SYS_FORCE_INLINE size_t
UTformatBuffer(char *buffer, size_t bufsize, const VtArray<T> &arr)
{
...
template <typename T>
static SYS_FORCE_INLINE size_t
UTformatBuffer(char *buffer, size_t bufsize, const VtValue &val)
{
    UT::Format::Writer		writer(buffer, bufsize);
    UT::Format::Formatter	f;
...
static SYS_FORCE_INLINE size_t
UTformatBuffer(char *buffer, size_t bufsize, const GfRange1f &r)
{
    UT::Format::Writer		writer(buffer, bufsize);
    UT::Format::Formatter	f;
...
static SYS_FORCE_INLINE size_t
UTformatBuffer(char *buffer, size_t bufsize, const GfRange1d &r)
{
    UT::Format::Writer		writer(buffer, bufsize);
    UT::Format::Formatter	f;
    return f.format(writer, "[{0}, {1}]", {r.GetMin(), r.GetMax()});
...
static SYS_FORCE_INLINE size_t
UTformatBuffer(char *buffer, size_t bufsize, const GfQuatd &q)
{
    return formatQuat(buffer, bufsize, q);
}
static SYS_FORCE_INLINE size_t
UTformatBuffer(char *buffer, size_t bufsize, const GfQuatf &q)
{
    return formatQuat(buffer, bufsize, q);
}
static SYS_FORCE_INLINE size_t
UTformatBuffer(char *buffer, size_t bufsize, const GfQuath &q)
{

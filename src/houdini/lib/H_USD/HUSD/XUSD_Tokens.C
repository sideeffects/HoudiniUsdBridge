...
HusdHdLightTokensType::HusdHdLightTokensType()
    ...
    , clippingRange("houdini:clippingRange", TfToken::Immortal)	
...
HusdHdRenderStatsTokensType::HusdHdRenderStatsTokensType()
    ...
    , worldToNDC("worldToNDC", TfToken::Immortal)
    , worldToRaster("worldToRaster", TfToken::Immortal)
    , clipNear("clipNear", TfToken::Immortal)
    , clipFar("clipFar", TfToken::Immortal)

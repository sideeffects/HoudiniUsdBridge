...
//
#ifndef __GUSD_SCOPEWRAPPER_H__
#define __GUSD_SCOPEWRAPPER_H__
...
{
public:
    GusdScopeWrapper( const UsdStagePtr& stage,
                      const SdfPath& path,
...
private:
    ...
    UsdGeomScope    m_usdScope;
};

PXR_NAMESPACE_CLOSE_SCOPE

#endif // __GUSD_SCOPEWRAPPER_H__
